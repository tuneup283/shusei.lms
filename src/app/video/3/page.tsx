  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gray-50 rounded-lg shadow-md p-6 mb-8 mt-8">
        <h2 className="text-2xl font-semibold mb-4">創設者と背景</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
          <li>性クラブの創設者は、徒歩での日本一周を達成した札幌のカリスマ経営者である伊藤氏であり、札幌する日本進会の会長でもある。</li>
          <li>小さな会社が潰れてしまう現状を憂い、企業を守るための活動を始めた。</li>
        </ul>

        <h2 className="text-2xl font-semibold mb-4">中小企業の現状</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
          <li>修正クラブは、新入社員や固定社員の給料を支払うことが難しい時代において、中小企業が直面する厳しい状況を反映している。</li>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-6">
          ...
          <li>各社長は、自社が「掛けのない会社」であることを認識し、絶対に潰してはいけないという意識を持つべきである。</li>
        </ul>

        <h2 className="text-2xl font-semibold mb-4">商売の精神</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li>「自分を甘くしない、自分に厳しく」という姿勢が求められ、商売繁盛に向けて一生懸命に取り組むことが重要である。</li>
          <li>性クラブは、掛けのない会社の社長たちが集まる場であり、経営者同士の結束が商売の成功に繋がるとされている。</li>
        </ul>
      </div>
